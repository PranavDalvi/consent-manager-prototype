...
describe("Audit Logs API", () => {
  ...
  /*
   * Grant consent before running the tests.
   *
   * Granting consent should automatically create
   * a CONSENT_GRANTED audit-log entry.
   */
  beforeAll(async () => {
  ...
  describe("GET /api/audit", () => {
    ...
    it("should return both grant and revoke audit logs", async () => {
       ...
       *
       * Revoking consent should automatically create
       * a CONSENT_REVOKED audit-log entry.
       */
      ...
      /*
       * Fetch audit logs after revoking consent.
       */
      const response = await request(app)
        .get("/api/audit")
        .query({
  ...
  /*
   * Remove only the records created by this test suite.
   */
  afterAll(async () => {
