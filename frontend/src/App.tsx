...
export default function App() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <ErrorBoundary>
        {notification && (
          <div className={`fixed top-4 right-4 left-4 md:left-auto md:w-96 z-[9999] p-4 rounded-xl border shadow-xl flex gap-3 items-start animate-in slide-in-from-top duration-300 ${
